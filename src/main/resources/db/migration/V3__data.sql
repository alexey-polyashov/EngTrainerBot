...
VALUES (100, 'study', ' [ˈstʌdɪ]', 'изучение, исследование, изучать', 'their study - их исследование, if you study - если вы изучаете, study periods - периоды обучени'),
 (101,'youth', ' [ju:θ]', 'юность, молодежь, молодежный', 'wild youth - бурная молодость, with youth -  с молодежью, in my youth - в моей молодости'),
 ...
 (106, 'speak up', '', 'громче, высказаться, выступать', 'We must speak up - мы должны говрить, speak up about - говорить о'),
